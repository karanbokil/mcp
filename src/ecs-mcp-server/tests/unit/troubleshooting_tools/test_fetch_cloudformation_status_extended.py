"""
Extended unit tests for the fetch_cloudformation_status module using pytest's native async test support.
"""
        ...
        "Stacks": [
            {
                ...
                "Outputs": [
                    {"OutputKey": "LoadBalancerDNS", "OutputValue": "test-lb-123.us-west-2.elb.amazonaws.com"},
    ...
    mock_cfn_client.describe_stack_events.return_value = {
        "StackEvents": [
            ...
            },
            {
                ...
                "PhysicalResourceId": "arn:aws:cloudformation:us-west-2:123456789012:stack/test-stack/abcdef",
...
async def test_fetch_cloudformation_status_access_denied():
    ...
    mock_cfn_client.describe_stacks.side_effect = ClientError(
        {"Error": {"Code": "AccessDenied", "Message": "User is not authorized to perform cloudformation:DescribeStacks"}},
        "DescribeStacks"
    )

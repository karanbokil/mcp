...
class TestEcsResourceManagementAPI:
    ...
    async def test_ecs_resource_management_describe_task_definition(self, mock_describe_task_definition):
    ...
    async def test_ecs_resource_management_list_container_instances(self, mock_list_container_instances):
    ...
    async def test_ecs_resource_management_describe_container_instance(self, mock_describe_container_instance):
        ...
        # Call the function
        result = await ecs_resource_management("describe", "container_instance", "test-instance", filters)
    ...
    async def test_ecs_resource_management_list_capacity_providers(self, mock_list_capacity_providers):
    ...
    async def test_ecs_resource_management_describe_capacity_provider(self, mock_describe_capacity_provider):
...
class TestContainerInstanceOperationsAPI:
    ...
    async def test_list_container_instances_success(self, mock_get_client):
        ...
        mock_ecs.list_container_instances.return_value = {
            "containerInstanceArns": ["arn:aws:ecs:us-east-1:123456789012:container-instance/test-cluster/instance-1"]
        }
        mock_ecs.describe_container_instances.return_value = {
            "containerInstances": [{
                "containerInstanceArn": "arn:aws:ecs:us-east-1:123456789012:container-instance/test-cluster/instance-1",

...
class TestInfrastructureWithRole(unittest.TestCase):
                    ...
                    "Outputs": [
                        {
                            ...
                            "OutputValue": "123456789012.dkr.ecr.us-east-1.amazonaws.com/test-app-repo",
                        },
                        {
    ...
    async def test_create_infrastructure_uses_role(
        ...
        """Test create_infrastructure uses the ECR role ARN when building and pushing Docker images."""
        # Set up mocks
        ...
        self.assertEqual(kwargs["repository_uri"], "123456789012.dkr.ecr.us-east-1.amazonaws.com/test-app-repo")
        self.assertEqual(kwargs["role_arn"], "arn:aws:iam::123456789012:role/test-app-ecr-pushpull-role")

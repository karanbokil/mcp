...
async def build_and_push_image(app_path: str, repository_uri: str, tag: str = None, role_arn: str = None) -> str:
    """
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to get ECR login password: {str(e)}")

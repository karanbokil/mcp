...
class TestFetchTaskLogs(unittest.TestCase):
    ...
    def test_with_explicit_start_time(self, mock_boto_client):
        ...
        result = fetch_task_logs("test-app", "test-cluster", None, 3600, None, start_time=start_time)
    ...
    def test_with_explicit_end_time(self, mock_boto_client):
        ...
        result = fetch_task_logs("test-app", "test-cluster", None, 3600, None, end_time=end_time)

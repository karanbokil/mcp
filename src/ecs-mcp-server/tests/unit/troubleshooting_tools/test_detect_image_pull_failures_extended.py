"""
Extended unit tests for the detect_image_pull_failures module using pytest's native async test support.
"""
    ...
    mock_get_task_defs.return_value = [
        {
            "taskDefinitionArn": "arn:aws:ecs:us-west-2:123456789012:task-definition/task1:1",
            "containerDefinitions": [
                {"name": "container1", "image": "123456789012.dkr.ecr.us-west-2.amazonaws.com/image1:latest"}
            ]
            # No executionRoleArn
        }
    ]

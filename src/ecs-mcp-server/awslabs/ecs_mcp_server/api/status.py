...
async def get_deployment_status(app_name: str, cluster_name: Optional[str] = None) -> Dict[str, Any]:
    """
...
async def _get_alb_url(app_name: str) -> Optional[str]:
    ...
    try:
        response = cloudformation.describe_stacks(
            StackName=f"{app_name}-ecs-infrastructure"
        )

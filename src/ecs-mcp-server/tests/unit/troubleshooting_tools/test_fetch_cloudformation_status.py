"""
Unit tests for the fetch_cloudformation_status function.
"""
...
class TestFetchCloudformationStatus(unittest.TestCase):
    """Unit tests for the fetch_cloudformation_status function."""
    
    @mock.patch("boto3.client")
    def test_stack_exists(self, mock_boto_client):
        ...
        mock_cf_client.list_stack_resources.return_value = {
            "StackResourceSummaries": [
                ...
                },
                {
                    ...
                    "PhysicalResourceId": "arn:aws:elasticloadbalancing:us-west-2:123456789012:loadbalancer/app/test-app/1234567890123456",
        ...
        mock_cf_client.describe_stack_events.return_value = {
            "StackEvents": [
                {
                    "StackId": "arn:aws:cloudformation:us-west-2:123456789012:stack/test-app/1234567890123456",
        ...
        # Call the function
        result = fetch_cloudformation_status("test-app")
        
        # Verify the result
        assert result["status"] == "success"
        assert result["stack_exists"] == True
        assert result["stack_status"] == "CREATE_COMPLETE"
        assert len(result["resources"]) == 2
        assert len(result["raw_events"]) == 1
    
    @mock.patch("boto3.client")
    def test_stack_failure(self, mock_boto_client):

...
class TestAWSRoleUtils(unittest.TestCase):
    ...
    async def test_get_ecr_login_password_with_role(self, mock_b64decode, mock_get_client, mock_get_client_with_role):
    ...
    @patch("awslabs.ecs_mcp_server.utils.aws.get_aws_client_with_role")
    @patch("base64.b64decode")
    async def test_get_ecr_login_password_without_role(self, mock_b64decode, mock_get_client_with_role, mock_get_client):
